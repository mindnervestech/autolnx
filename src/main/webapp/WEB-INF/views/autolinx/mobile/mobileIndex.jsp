                ...
                <ul>
                   ...
                   <c:choose>
				    <c:when test="${sliderImages.size()>=1}">
				       <li data-transition="fade" data-delay="4000" data-slotamount="10" data-speed="100" data-masterspeed="300"  style="height: 500px !important;"> 
                        <!-- MAIN IMAGE --> 
...
// 									el.height(imageHeight);
    ...
    <div class="message-shadow"></div>
     <!-- <div class="row">
        	 <div class="col-md-6"> -->
    <div class="boxIn" style="z-index: 200">
