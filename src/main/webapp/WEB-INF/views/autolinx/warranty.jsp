        ...
        <div class="container-fluid"> 
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav pull-right" style="margin-top: 14px;">
              ...
              <li class="active" ng-if="${warHeader.hideMenu == 0}"><a href="${pageContext.request.contextPath}/warranty">Warranty</a></li>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
        <h2> ${warHeader.headerTitle} </h2>
        <h4> ${warHeader.subTitle} </h4>
      </div>
