...
<section class="content">
    <div class="container">
        <div class="inner-page inventory-3">
            <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr ng-if="${vehicles[0].engine != null} || ${vehicles[1].engine != null} || ${vehicles[2].engine != null}">
                                            <td>Engine:</td>
                                            <td ng-if="${option.engine != null}">${option.engine}</td>
                                             <td ng-if="${option.engine == null}">N/A</td>
                                        </tr>
                                        <tr ng-if="${vehicles[0].transmission != null} || ${vehicles[1].transmission != null} || ${vehicles[2].transmission != null}">
                                            <td>TRANSMISSION:</td>
                                            <td ng-if="${option.transmission != null}">${option.transmission}</td>
                                            <td ng-if="${option.transmission == null}">N/A</td>
                                        </tr>
                                        <tr ng-if="${vehicles[0].drivetrain != null} || ${vehicles[1].drivetrain != null} || ${vehicles[2].drivetrain != null}">
                                            <td>DRIVETRAIN:</td>
                                        ...
                                        <tr ng-if="${vehicles[0].extColor != ''} || ${vehicles[1].extColor != ''} || ${vehicles[2].extColor != ''}">
                                            <td>EXTERIOR:</td>
                                            <td ng-if="${option.extColor != ''}">${option.extColor}</td>
                                             <td ng-if="${option.extColor == ''}">N/A</td>
                                        </tr>
                                        <tr ng-if="${vehicles[0].intColor != null} || ${vehicles[1].intColor != null} || ${vehicles[2].intColor != null}">
                                            <td>INTERIOR:</td>
                                            <td ng-if="${option.intColor != null}">${option.intColor}</td>
                                             <td ng-if="${option.intColor == null}">N/A</td>
                                        </tr>
                                        <tr ng-if="${vehicles[0].mileage != null} || ${vehicles[1].mileage != null} || ${vehicles[2].mileage != null}">
                                            <td>MILES:</td>
                                            <td ng-if="${option.mileage != null}">${option.mileage}</td>
                                             <td ng-if="${option.mileage == null}">N/A</td>
                                        </tr>
                                        <tr ng-if="${vehicles[0].doors != null} || ${vehicles[1].doors != null} || ${vehicles[2].doors != null}">
                                            <td>DOORS:</td>
                                        ...
                                        <tr ng-if="${vehicles[0].stock != null} || ${vehicles[1].stock != null} || ${vehicles[2].stock != null}">
                                            <td>STOCK #:</td>
                                            <td ng-if="${option.stock != null}">${option.stock}</td>
                                             <td ng-if="${option.stock == null}">N/A</td>
                                        </tr>
                                        <tr ng-if="${vehicles[0].vin != null} || ${vehicles[1].vin != null} || ${vehicles[2].vin != null}">
                                            <td>VIN #:</td>
                                            <td ng-if="${option.vin != null}">${option.vin}</td>
                                             <td ng-if="${option.vin == null}">N/A</td>
                                        </tr>
                                        <tr ng-if="${vehicles[0].cityMileage != null} || ${vehicles[1].cityMileage != null} || ${vehicles[2].cityMileage != null}">
                                            <td>FUEL MILEAGE:</td>
                                            <td ng-if="${option.cityMileage != null}">${option.cityMileage}/${option.highwayMileage}</td>
                                             <td ng-if="${option.cityMileage == null}">N/A</td>
                                        </tr>
                                        <tr ng-if="${vehicles[0].fuelType != null} || ${vehicles[1].fuelType != null} || ${vehicles[2].fuelType != null}">
                                            <td>FUEL TYPE:</td>
                                            <td ng-if="${option.fuelType != null}">${option.fuelType}</td>
                                             <td ng-if="${option.fuelType == null}">N/A</td>
                                        </tr>
                                        <tr ng-if="${vehicles[0].make != null} || ${vehicles[1].make != null} || ${vehicles[2].make != null}">
                                            <td>CONDITION:</td>
...
.dynamic-image-1-1 {
  		background: url(${hostnameimg}${compareHeader.path}) no-repeat center;
  	}
