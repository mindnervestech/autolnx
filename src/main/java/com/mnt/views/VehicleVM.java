...
public class VehicleVM {
	...
	public String getPrevVehicle() {
		return prevVehicle;
	}
	public void setPrevVehicle(String prevVehicle) {
		this.prevVehicle = prevVehicle;
	}
	public String getNextVehicle() {
		return nextVehicle;
	}
	public void setNextVehicle(String nextVehicle) {
	...
	public String getActiveHeadRestraints() {
		return activeHeadRestraints;
	}
	public void setActiveHeadRestraints(String activeHeadRestraints) {
		this.activeHeadRestraints = activeHeadRestraints;
	}
	...
	public String getImpactSensors() {
		return impactSensors;
	}
	public void setImpactSensors(String impactSensors) {
		this.impactSensors = impactSensors;
	}
	...
	public void setPowerOutlets(String powerOutlets) {
